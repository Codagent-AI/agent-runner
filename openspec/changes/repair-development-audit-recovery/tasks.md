...
- [x] 1. Preserve valid observations when optional notes are unsafe, with tests.
- [x] 2. Persist and clear Sheets delivery failures without losing audit warnings, with tests.
