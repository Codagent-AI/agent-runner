...
- `workflows/openspec/define-change.yaml`: `proposal` and `approach-review`;
- `workflows/openspec/plan-change2.yaml`: `review-tasks`;
- `workflows/openspec/implement-change2.yaml`: `prepare-acceptance`;
- `workflows/openspec/accept-change.yaml`: `run-reacceptance-testing`.
