# live-run-view Specification

## Purpose
Define the live run terminal interface that displays workflow execution state, streams step output, and keeps interactive workflow control inside the TUI.
## Requirements
