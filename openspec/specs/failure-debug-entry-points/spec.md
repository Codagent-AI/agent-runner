# failure-debug-entry-points Specification

## Purpose
Define the user-facing entry points that route failed runs into the built-in debug workflow from the home TUI, run view, and onboarding failure flow.
