...
- **Plan-tasks skill**: Use the `codagent:plan-tasks` skill for the review. This is the authoritative reference for task granularity — splitting rules, merge test, anti-patterns, and examples. Use it to evaluate whether the task breakdown is at the right level.
